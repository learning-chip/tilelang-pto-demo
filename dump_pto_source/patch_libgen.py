    ...
    def patched_compile_lib(self, timeout: float = None):
        ...
        if self.target == "ascendc" or self.target == "auto":
            ...
            command = [
                ...
                "-DL2_CACHE_HINT",
                "-I../../src/",
                # NOTE: includes pinned pto-isa header **before** including $ASCEND_HOME_PATH/include,
                # otherwise will default to CANN's pto-isa header, failing on examples that required newer pto-isa
